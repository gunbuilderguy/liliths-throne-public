...
public class DogmeatDialogue {
	...
	public static final DialogueNode KATE_DOGMEAT_AFTER_SEX = new DialogueNode("The back alley", ".", false) {
		...
		public String getContent() {
			return "<p>"
					+ "Dogmeat shakes himself and lies down, heavy and slow. He's done."
					+ "</p>"
					+ "<p>"
					+ "Kate goes to him. Not called &mdash; she just moves, crosses the space between them"
					+ " and crouches at his side. She runs her hands along his flank once, checking"
					+ " the way you'd check something you wanted to make sure was still there."
					+ " He breathes out, slow, and his tail moves once against the cobblestones."
					+ "</p>"
					+ "<p>"
					+ "She stays like that for a while. Her hands settle. She's not performing anything"
					+ " &mdash; just present with him, quiet, until his breathing evens out fully."
					+ "</p>"
					+ "<p>"
					+ "At some point she glances at you. Doesn't say anything. Just checks."
					+ "</p>"
					+ "<p>"
					+ "Eventually she stands, straightens out her jacket, pushes her hair back."
					+ " She gives Dogmeat one last slow scratch at the back of his neck before she does."
					+ "</p>"
					+ "<p>"
	...
	public static final DialogueNode DOGMEAT_ENCOUNTER_WITH_KATE_AFTER = new DialogueNode("The back alley", ".", false) {
		...
		public String getContent() {
			return "<p>"
					...
					+ "</p>"
					+ "<p>"
					+ "Dogmeat settles beside her. She looks at him for a moment &mdash; really looks,"
					+ " the way you do when you're assessing whether something is okay &mdash; then"
					+ " crouches and runs both hands along the sides of his face, up behind his ears,"
					+ " checking him over with the focused quiet of someone who knows what they're doing."
					+ " He leans into it. His tail sweeps the cobblestones once."
					+ "</p>"
					+ "<p>"
					+ "She stays down at his level for a while. When she finally stands it's unhurried,"
					+ " one hand resting on his head a moment longer before she lets go."
					+ "</p>"
					+ "<p>"
