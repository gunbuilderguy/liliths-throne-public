 ...
 * @author Innoxia
 */
public class Copper extends NPC implements StallionTraitsProvider {

	private static final List<StallionTrait> TRAITS = Util.newArrayListOfValues(
			StallionTrait.PEDIGREE, StallionTrait.WELL_TRAINED, StallionTrait.EAGER);
	...
	public Copper(boolean isImported) {
		super(isImported,
				new NameTriplet("Copper"), "",
				"The oldest of Sally's three stallions, Copper is a gentle dapple grey who has been with the stables since he was a foal.",
				12, Month.SEPTEMBER, 3,
	...
	public void setStartingBody(boolean setPersona) {
		...
		this.setSkinCovering(new Covering(BodyCoveringType.HORSE_HAIR, CoveringPattern.NONE, PresetColour.COVERING_GREY, false, PresetColour.COVERING_WHITE, false), true);
